<div class="form-group{{ $errors->has('codgo_prov') ? ' has-error' : '' }}">
	<div class="col-md-6">
	    <input type="hidden" id="codgo_prov" type="text" class="form-control" name="codgo_prov" value="{{ old('codgo_prov') }}">
	</div>
</div>
...
<div class="form-group{{ $errors->has('descrpcion') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
	    <input id="descrpcion" type="text" class="form-control" name="descrpcion" value="{{ old('descrpcion') }}">
...
<div class="form-group{{ $errors->has('precio_dolar') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="precio_dolar" type="text" class="form-control" name="precio_dolar" value="{{ old('precio_dolar') }}">
...
<div class="form-group{{ $errors->has('cargo') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="precio_euro" type="text" class="form-control" name="precio_euro" value="{{ old('precio_euro') }}">
