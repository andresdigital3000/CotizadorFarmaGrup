...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="caldad_contcto" type="text" class="form-control" name="caldad_contcto" value={!!$cliente->caldad_contcto!!} size="15">
			...
			<th>
				<input id="caldad_tels" type="text" class="form-control" name="caldad_tels" value={!!$cliente->caldad_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="desrrllo_contcto" type="text" class="form-control" name="desrrllo_contcto" value={!!$cliente->desrrllo_contcto!!} size="15">
			...
			<th>
				<input id="desrrllo_tels" type="text" class="form-control" name="desrrllo_tels" value={!!$cliente->desrrllo_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="prodccion_contcto" type="text" class="form-control" name="prodccion_contcto" value={!!$cliente->prodccion_contcto!!} size="15">
			...
			<th>
				<input id="prodccion_tels" type="text" class="form-control" name="prodccion_tels" value={!!$cliente->prodccion_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="planta_contcto" type="text" class="form-control" name="planta_contcto" value={!!$cliente->planta_contcto!!} size="15">
			...
			<th>
				<input id="planta_tels" type="text" class="form-control" name="planta_tels" value={!!$cliente->planta_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="compras_contcto" type="text" class="form-control" name="compras_contcto" value={!!$cliente->compras_contcto!!} size="15">
			...
			<th>
				<input id="compras_tels" type="text" class="form-control" name="compras_tels" value={!!$cliente->compras_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="estbldad_contcto" type="text" class="form-control" name="estbldad_contcto" value={!!$cliente->estbldad_contcto!!} size="15">
			...
			<th>
				<input id="estbldad_tels" type="text" class="form-control" name="estbldad_tels" value={!!$cliente->estbldad_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="mantnmiento_contcto" type="text" class="form-control" name="mantnmiento_contcto" value={!!$cliente->mantnmiento_contcto!!} size="15">
			...
			<th>
				<input id="mantnmiento_tels" type="text" class="form-control" name="mantnmiento_tels" value={!!$cliente->mantnmiento_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="tesrria_contcto" type="text" class="form-control" name="tesrria_contcto" value={!!$cliente->tesrria_contcto!!} size="15">
			...
			<th>
				<input id="tesrria_tels" type="text" class="form-control" name="tesrria_tels" value={!!$cliente->tesrria_tels!!} size="10">
...
<div> 
	<table>
		<td>
			...
			<th>
				<input id="otro_contcto" type="text" class="form-control" name="otro_contcto" value={!!$cliente->otro_contcto!!} size="15">
			...
			<th>
				<input id="otro_tels" type="text" class="form-control" name="otro_tels" value={!!$cliente->otro_tels!!} size="10">
