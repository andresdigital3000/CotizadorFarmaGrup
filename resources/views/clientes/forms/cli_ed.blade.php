<div class="form-group{{ $errors->has('nit') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
	    <input id="nit" type="text" class="form-control" name="nit" maxlength="15" value="{!!$cliente->nit!!}">
		@if ($errors->has('nit'))
...
<div class="form-group{{ $errors->has('razonsocial') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="razonsocial" type="text" class="form-control" name="razonsocial" maxlength="75" value="{!!$cliente->razonsocial!!}">
...
<div class="form-group{{ $errors->has('ubccion') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="ubccion" type="text" class="form-control" name="ubccion" maxlength="120" value="{!!$cliente->ubccion!!}">
...
<div class="form-group{{ $errors->has('ciudad') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="ciudad" type="text" class="form-control" name="ciudad" maxlength="30" value="{!!$cliente->ciudad!!}">
...
<div class="form-group{{ $errors->has('pais') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="pais" type="pais" class="form-control" name="pais" maxlength="30" value="{!!$cliente->pais!!}">
		@if ($errors->has('pais'))
...
<div class="form-group{{ $errors->has('telfno') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="telfno" type="text" class="form-control" name="telfno" maxlength="50" value="{!!$cliente->telfno!!}">
...
<div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="fax" type="text" class="form-control" name="fax" maxlength="50" value="{!!$cliente->fax!!}">
		@if ($errors->has('fax'))
...
<div class="form-group{{ $errors->has('fechaIngrso') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="fechaIngrso" type="text" class="form-control" name="fechaIngrso" maxlength="20" value="<?php echo date("d/m/Y"); ?>" style="display:none">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="caldad_contcto" type="text" class="form-control" name="caldad_contcto" maxlength="50" value="{!!$cliente->caldad_contcto!!}">
	...
	<div class="col-md-3">
		<input id="caldad_tels" type="text" class="form-control" name="caldad_tels" maxlength="20" value="{!!$cliente->caldad_tels!!}">
		@if ($errors->has('caldad_contcto'))
	...
	<div class="col-md-3">
		<input id="caldad_email" type="text" class="form-control" name="caldad_email" maxlength="25" value="{!!$cliente->caldad_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="desrrllo_contcto" type="text" class="form-control" name="desrrllo_contcto" maxlength="50" value="{!!$cliente->desrrllo_contcto!!}">
	...
	<div class="col-md-3">
		<input id="desrrllo_tels" type="text" class="form-control" name="desrrllo_tels" maxlength="20" value="{!!$cliente->desrrllo_tels!!}">
	...
	<div class="col-md-3">
		<input id="desrrllo_email" type="text" class="form-control" name="desrrllo_email" maxlength="25" value="{!!$cliente->desrrllo_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="prodccion_contcto" type="text" class="form-control" name="prodccion_contcto" maxlength="50" value="{!!$cliente->prodccion_contcto!!}">
	...
	<div class="col-md-3">
		<input id="prodccion_tels" type="text" class="form-control" name="prodccion_tels" maxlength="20" value="{!!$cliente->prodccion_tels!!}">
	...
	<div class="col-md-3">
		<input id="prodccion_email" type="text" class="form-control" name="prodccion_email" maxlength="25" value="{!!$cliente->prodccion_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="planta_contcto" type="text" class="form-control" name="planta_contcto" maxlength="50" value="{!!$cliente->planta_contcto!!}">
	...
	<div class="col-md-3">
		<input id="planta_tels" type="text" class="form-control" name="planta_tels" maxlength="20" value="{!!$cliente->planta_tels!!}">
	...
	<div class="col-md-3">
		<input id="planta_email" type="text" class="form-control" name="planta_email" maxlength="25" value="{!!$cliente->planta_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="compras_contcto" type="text" class="form-control" name="compras_contcto" maxlength="50" value="{!!$cliente->compras_contcto!!}">
	...
	<div class="col-md-3">
		<input id="compras_tels" type="text" class="form-control" name="compras_tels" maxlength="20" value="{!!$cliente->compras_tels!!}">
	...
	<div class="col-md-3">
		<input id="compras_email" type="text" class="form-control" name="compras_email" maxlength="25" value="{!!$cliente->compras_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="estbldad_contcto" type="text" class="form-control" name="estbldad_contcto" maxlength="50" value="{!!$cliente->estbldad_contcto!!}">
	...
	<div class="col-md-3">
		<input id="estbldad_tels" type="text" class="form-control" name="estbldad_tels" maxlength="20" value="{!!$cliente->estbldad_tels!!}">
	...
	<div class="col-md-3">
		<input id="estbldad_email" type="text" class="form-control" name="estbldad_email" maxlength="25" value="{!!$cliente->estbldad_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="mantnmiento_contcto" type="text" class="form-control" name="mantnmiento_contcto" maxlength="50" value="{!!$cliente->mantnmiento_contcto!!}">
	...
	<div class="col-md-3">
		<input id="mantnmiento_tels" type="text" class="form-control" name="mantnmiento_tels" maxlength="20" value="{!!$cliente->mantnmiento_tels!!}">
	...
	<div class="col-md-3">
		<input id="mantnmiento_email" type="text" class="form-control" name="mantnmiento_email" maxlength="25" value="{!!$cliente->mantnmiento_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="tesrria_contcto" type="text" class="form-control" name="tesrria_contcto" maxlength="50" value="{!!$cliente->tesrria_contcto!!}">
	...
	<div class="col-md-3">
		<input id="tesrria_tels" type="text" class="form-control" name="tesrria_tels" maxlength="20" value="{!!$cliente->tesrria_tels!!}">
	...
	<div class="col-md-3">
		<input id="tesrria_email" type="text" class="form-control" name="tesrria_email" maxlength="25" value="{!!$cliente->tesrria_email!!}">
...
<div class="form-group">
	...
	<div class="col-md-3">
		<input id="otro_contcto" type="text" class="form-control" name="otro_contcto" maxlength="50" value="{!!$cliente->otro_contcto!!}">
	...
	<div class="col-md-3">
		<input id="otro_tels" type="text" class="form-control" name="otro_tels" maxlength="20" value="{!!$cliente->tesrria_tels!!}">
	...
	<div class="col-md-3">
		<input id="otro_email" type="text" class="form-control" name="otro_email" maxlength="25" value="{!!$cliente->otro_email!!}">
...
<div class="form-group{{ $errors->has('reprsntntelegal') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="reprsntntelegal" type="text" class="form-control" name="reprsntntelegal" maxlength="50" value="{!!$cliente->reprsntntelegal!!}">
