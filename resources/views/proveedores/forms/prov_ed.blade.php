							<div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
								    <input id="id" type="text" disabled="disabled" class="form-control" name="id" value={!!$user->id!!}>
								    @if ($errors->has('id'))
							...
							<div class="form-group{{ $errors->has('extension') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="extension" type="text" class="form-control" name="extension" value={!!$user->extension!!}>
