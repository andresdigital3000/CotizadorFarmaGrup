...
<div class="form-group{{ $errors->has('ciudad') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="ciudad" type="ciudad" class="form-control" name="ciudad" value="{{ old('ciudad') }}">
...
<div class="form-group{{ $errors->has('contcto') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="contcto" type="text" class="form-control" name="contcto" value="{{ old('contcto') }}">
...
<div class="form-group{{ $errors->has('bancarios_cc') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="bancarios_cc" type="text" class="form-control" name="bancarios_cc" value="{{ old('bancarios_cc') }}">
...
<div class="form-group{{ $errors->has('bancarios_swiftcode') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="bancarios_swiftcode" type="text" class="form-control" name="bancarios_swiftcode" value="{{ old('bancarios_swiftcode') }}">
...
<div class="form-group{{ $errors->has('bancarios_refrnce') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="bancarios_refrnce" type="text" class="form-control" name="bancarios_refrnce" value="{{ old('bancarios_refrnce') }}">
...
<div class="form-group{{ $errors->has('bancarios_tt') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="bancarios_tt" type="text" class="form-control" name="bancarios_tt" value="{{ old('bancarios_tt') }}">
...
<div class="form-group{{ $errors->has('bancarios_estdo') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="bancarios_estdo" type="text" class="form-control" name="bancarios_estdo" value="{{ old('bancarios_estdo') }}">
