<div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
	    <input id="id" type="text" class="form-control" name="id" value="{{ old('id') }}" maxlength="10">
		@if ($errors->has('id'))
...
<div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="nombre" type="text" class="form-control" name="nombre" value="{{ old('nombre') }}" maxlength="50">
...
<div class="form-group{{ $errors->has('extension') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="extension" type="text" class="form-control" name="extension" value="{{ old('extension') }}" maxlength="5">
...
<div class="form-group{{ $errors->has('cargo') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="cargo" type="text" class="form-control" name="cargo" value="{{ old('cargo') }}" maxlength="25">
		@if ($errors->has('cargo'))
...
<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" maxlength="15">
		@if ($errors->has('name'))
...
<div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="password" type="password" class="form-control" name="password" maxlength="15">
...
<div class="form-group{{ $errors->has('password-confirm') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="password-confirm" type="password" class="form-control" name="password-confirm" maxlength="15">
